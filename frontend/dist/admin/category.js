...
function loadCategory() {
    return __awaiter(this, void 0, void 0, function* () {
        let data = yield category.getCategoryAll();
...
formEdit.addEventListener("submit", (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield fetch(`http://localhost:8066/api/editCategory/${id}`, {
            method: "PUT",
...
formAdd.addEventListener("submit", (e) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let categoryName = formData.get("categoryName");
    try {
        const response = yield fetch(`http://localhost:8066/api/addCategory`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ categoryName })
        });
...
const deleteCategory = () => {
    document.querySelectorAll('.deleteCategory').forEach(item => {
        item.addEventListener('click', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            console.log(id);
            try {
                const response = yield fetch(`http://localhost:8066/api/deleteCategory/${id}`, {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
                });
                if (response.ok) {
